...
import study.demo.item.infrastructure.jdbctemplate.JdbcTemplateItemRepository_V2;
...
public class JdbcTemplateConfig_V2 {
    ...
    public ItemRepository_V1 itemRepository() {
        return new JdbcTemplateItemRepository_V2(dataSource);
    }
