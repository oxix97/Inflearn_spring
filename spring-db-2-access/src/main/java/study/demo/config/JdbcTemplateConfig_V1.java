...
import study.demo.item.infrastructure.jdbctemplate.JdbcTemplateItemRepository_V1;
...
public class JdbcTemplateConfig_V1 {
    ...
    public ItemRepository_V1 itemRepository() {
        return new JdbcTemplateItemRepository_V1(dataSource);
    }
